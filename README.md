...
- **[AG Grid](https://www.ag-grid.com/)** - Enterprise-grade data grid for displaying stock information
- **[React Context](https://react.dev/reference/react/useContext)** - Global state management via `StocksContext` for sharing data across components
